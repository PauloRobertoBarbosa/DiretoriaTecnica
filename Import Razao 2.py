...
razao = pd.read_csv('Realizado 2020 VP tecnica.txt', quoting=3, delimiter=';', skiprows=26, encoding='ANSI', thousands='.', decimal=',', low_memory=False, error_bad_lines=True)
...
for CC in dflastmonth['Centro de Custo'].unique():
    excel = pd.ExcelWriter(r'C:/Users/paulo.roberto/Documents/ResumoCASK/razao - 2020 - CC - {}.xlsx'.format(CC),engine='xlsxwriter')
