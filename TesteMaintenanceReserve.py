...
arquivo = pd.ExcelFile("Maintenance Reserve - 2019.xlsx")
...
excel = pd.ExcelWriter(r'C:\Users\paulo.roberto\Documents\Maintenance Reserve - IATA\Resmat.xlsx',engine='xlsxwriter')
